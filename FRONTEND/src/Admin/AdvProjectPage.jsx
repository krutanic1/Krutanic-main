                ...
                <div className="form">
                    <form onSubmit={handleSubmit} style={{ maxWidth: '800px', height: '80vh' }}>
                        ...
                        <select value={selectedCourseId} onChange={(e) => setSelectedCourseId(e.target.value)} required>
                            <option value="">-- Select Advance Course --</option>
                            {courses.map(course => (
                        ...
                        {showJsonInput ? (
                            <div style={{ marginTop: '20px' }}>
                                ...
                                />
                                <button type="button" onClick={handleApplyJson} style={{ background: '#f15b29', padding: '10px', marginTop: '10px' }}>
                                    Apply JSON Roadmap
                                </button>
                            </div>
                        ) : (
                            <>
                                <p style={{ fontSize: '12px', color: '#666' }}>Enter phase name and 5 tasks for each week.</p>
                                <div style={{ marginTop: '20px' }}>
                    ...
                    <table>
                        ...
                        <tbody>
                            {projects.map((proj, index) => (
                                <tr key={proj._id}>
                                    <td>{index + 1}</td>
                                    <td>{proj._courseTitle || "Unknown Course"}</td>
                                    <td>{proj.title}</td>
                                    <td>{proj.level}</td>
                                    <td>
                            ...
                            {projects.length === 0 && (
                                <tr>
                                    <td colSpan="5">No advance projects yet. Add one to get started!</td>
                                </tr>
                            )}
                        </tbody>
                    </table>
