...
const AdminMedLeaderboard = () => {
  ...
  const [getmedteamname, setgetmedteamname] = useState([]);
  ...
  const fetchAllData = async () => {
    try {
      const response = await axios.get(`${API}/medbda-with-enrolls`);
  ...
  const fetchTeamname = async () => {
    try {
      ...
      setgetmedteamname(response.data);
    } catch (error) {
    ...
    <div id="AdminAddCourse">
      ...
      <div className="coursetable">
        ...
        <div>
          {selectedTeam &&
            (() => {
              const team = getmedteamname.find((t) => t.teamname === selectedTeam);
...
export default AdminMedLeaderboard;
