      ...
      <div className="sidebar">
        ...
        {activeSection === "mentorship" && (
          <>
            ...
            <Link to="/AdminSalaryFormulas">
              <i className="fa fa-cogs mr-2"></i>Manage Formulas
            </Link>
            ...
            <Link to="/AdminNotes">
              <i className="fa fa-book mr-2"></i>Notes Hub (Add Notes)
            </Link>
            <Link to="/AdminFeedback">
              <i className="fa fa-comments mr-2"></i>Student Feedback
            </Link>
        ...
        {activeSection === "advance" && (
          <>
            ...
            <Link to="/admin/adv-filter">
              <i className="fa fa-filter mr-2"></i>ADV Filter
            </Link>
            <Link to="/admin/career-assessments">
