    ...
    <div id="AdminAddCourse">
      ...
      {loading ? (
        ...
        <div className="coursetable">
          <div className="mb-2">
            <h2>ADV Full Paid List ({filteredEnrollments.length})</h2>
              ...
              {Object.keys(groupedData).length > 0 ? (
                Object.keys(groupedData).sort((a, b) => {
                  ...
                  <React.Fragment key={date}>
                    <tr>
                      <td colSpan="14" style={{ fontWeight: "bold", backgroundColor: "#e8f5e9" }}>
                ...
                <tr>
                  <td colSpan="14">No full paid enrollments found</td>
                </tr>
              )}
            </tbody>
          </table>
