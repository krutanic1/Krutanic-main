...
const AdminMedTarget = () => {
  ...
  const handleAsignTargetToTeam = async (e, teamId) => {
    ...
    try {
      ...
      const response = await axios.post(`${API}/medteamtargetassigntoteam`, payload);
  ...
  const handleDeleteTargetTeam = async (target, teamId) => {
    ...
    if (!confirm) return;
    try {
      await axios.delete(`${API}/delete-medteam-target`, {
        data: {
          teamId,
          targetId: target._id,
        },
  ...
  return (
    <div id="AdminAddCourse">
      ...
      <div>
        <h2>Target Assign to Med Team</h2>
        <div className="mb-4">
      ...
      <h2>Target Assign To Med Team Member</h2>
      <div className="coursetable">
        {loading ? (
          <div id="loader">
            <div className="three-body">
