...
const AdminMedRevenue = () => {
  ...
  const handleLeadClick = async (monthStr, type, page = 1) => {
    ...
    try {
      const response = await axios.get(`${API}/getmedmonthlyleads`, {
  ...
  const fetchMonthlyStats = async (page = 1) => {
    try {
      ...
      const response = await axios.get(`${API}/getmedmonthlyrevenue`, {
  ...
  const fetchDailyData = async () => {
    try {
      ...
      const response = await axios.get(`${API}/getmeddailyrevenue`, { params });
  ...
  return (
    <div className="p-6 ml-[270px] mx-auto">
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-4">Med Department Monthly Revenue Summary</h2>
        <div className="overflow-x-auto bg-white rounded shadow-sm">
          <table className="min-w-full border-collapse border border-gray-200">
      ...
      <section className="text-lg font-semibold bg-gray-50 p-4 rounded border">
        <h2 className="text-xl font-semibold mb-2">Total Med Revenue Till Now</h2>
...
export default AdminMedRevenue;
