...
const SpecializationsSection = () => {
  ...
  const courses = [
    ...
    { title: "Data Analytics", domain: "Computer Science", rating: 4.7, students: "2,690+", duration: "2/3 Months", link: "/mentorship/data-analytics", desc: "Interpreting data to help businesses improve performance and make decisions." },
