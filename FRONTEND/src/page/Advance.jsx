  ...
  return (
    <div id="advance" className="">
            ...
            <div className="rounded-lg lg:w-1/2 md:w-1/2 text-black p-3 overflow-y-auto max-h-[90vh]">
              ...
              <form onSubmit={handleFormSubmit} className="space-y-2">
                ...
                <input
                  ...
                  id="passedOutYear"
                  name="passedOutYear"
                  placeholder="Passed Out Year (e.g. 2025)"
      ...
      <div className="fixed bottom-8 bg-green-800 animate-bounce right-7 z-50 px-3 py-2 rounded-full">
        <a
          href="https://api.whatsapp.com/send?phone=7829104024&text=Hello%20Krutanic%20Team,%0A%0AI%20have%20some%20queries%20regarding%20my%20course.%0A%0AThank%20you!"
          target="_blank"
