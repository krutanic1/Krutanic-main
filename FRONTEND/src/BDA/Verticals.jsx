...
import API from "../API";
import BDAHeader from "./BDAHeader";
...
const Verticals = () => {
  ...
  }, [bdaId, filterMonth, filterYear]);

  const fetchVerticals = async () => {
    setLoading(true);
    try {
      const response = await axios.get(`${API}/api/vertical/manager/${bdaId}?month=${filterMonth}&year=${filterYear}`, { withCredentials: true });
