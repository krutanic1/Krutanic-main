...
// PaymentSuccess page eliminated — success UI now lives inside FreeCareerAssessment (single-page flow)
// Admin
...
import MedOnboardingDetails from "./Admin/MedOnboardingDetails";
import AdminMedApprovals from "./Admin/AdminMedApprovals";
...
import AdminMedTarget from "./Admin/AdminMedTarget";
import AdminMedVerticals from "./Admin/AdminMedVerticals";
import AdminVerticals from "./Admin/AdminVerticals";
...
import AdminTeamAnalysis from "./Admin/AdminTeamAnalysis";
...
import OperationMentorshipDefaultRatio from "./Operation/OperationMentorshipDefaultRatio";
...
import Verticals from "./BDA/Verticals";
import TeamAnalysis from "./BDA/TeamAnalysis";
...
import Feedback from "./new_user/feedback";
...
import AdvLeadsCount from "./AdvTeam/AdvLeadsCount";
import SalesIntelligence from "./Admin/SalesIntelligence";
...
import AdvFollowups from "./AdvTeam/AdvFollowups";
...
import MedTeamDetail from "./MedTeam/MedTeamDetail";
import MedTeamAssignTarget from "./MedTeam/AssignTarget";
import MedTeamVerticals from "./MedTeam/MedTeamVerticals";
import MedLeaderboard from "./MedTeam/MedLeaderboard";
...
const NotesPage = lazy(() => import("./page/NotesPage"));
...
const AppContent = () => {
  ...
  const operationheaderPaths = ["/operationdashboard", "/fullpayment", "/bookedpayment", "/defaultpayment", "/operationrevenuesheet", "/operationmentorshipdefaultratio"];
    ...
    <div>
      ...
      <Routes>
        ...
        <Route path="/notes" element={
          <React.Suspense fallback={<div style={{ minHeight: '100vh', background: '#0f0c29' }} />}>
            <NotesPage />
          </React.Suspense>
        } />
        ...
        <Route path="/MedOnboardingDetails" element={isAuthenticatedAdmin() ? <MedOnboardingDetails /> : <Navigate to="/AdminLogin" />} />
        <Route path="/adminmedapprovals" element={isAuthenticatedAdmin() ? <AdminMedApprovals /> : <Navigate to="/AdminLogin" />} />
        ...
        <Route path="/admin/adv-filter" element={isAuthenticatedAdmin() ? <AdvTeamFilter /> : <Navigate to="/AdminLogin" />} />
        ...
        <Route path="/AdminMedTarget" element={isAuthenticatedAdmin() ? <AdminMedTarget /> : <Navigate to="/AdminLogin" />} />
        <Route path="/AdminMedVerticals" element={isAuthenticatedAdmin() ? <AdminMedVerticals /> : <Navigate to="/AdminLogin" />} />
        <Route path="/AdminVerticals" element={isAuthenticatedAdmin() ? <AdminVerticals /> : <Navigate to="/AdminLogin" />} />
        ...
        <Route path="/AdminTeamAnalysis" element={isAuthenticatedAdmin() ? (<AdminTeamAnalysis />) : (<Navigate to="/AdminLogin" />)} />
        <Route path="/AdminFeedback" element={isAuthenticatedAdmin() ? (<AdminFeedback />) : (<Navigate to="/AdminLogin" />)} />
        ...
        <Route path="/admin/sales-intelligence" element={isAuthenticatedAdmin() ? (<SalesIntelligence />) : (<Navigate to="/AdminLogin" />)} />
        {/* Notes Hub Admin */}
        <Route path="/AdminNotes" element={isAuthenticatedAdmin() ? <AdminNotesPage /> : <Navigate to="/AdminLogin" />} />
        {/* Admin Panel End */}
        ...
        <Route path="/OperationMentorshipDefaultRatio" element={isAuthenticatedOperation() ? <OperationMentorshipDefaultRatio /> : <Navigate to="/OperationLogin" />} />
        ...
        {/* med team pages */}
        <Route path="/medteam/teamdetail" element={isAuthenticatedMedTeam() ? <MedTeamDetail /> : <Navigate to="/medloginteam" />} />
        ...
        <Route path="/advteam/filter" element={isAuthenticatedAdvTeam() ? <AdvTeamFilter /> : <Navigate to="/AdvTeamLogin" />} />
        ...
        <Route path="/advteam/followups" element={isAuthenticatedAdvTeam() ? <AdvFollowups /> : <Navigate to="/AdvTeamLogin" />} />
        ...
        <Route path="/medteam/assigntarget" element={isAuthenticatedMedTeam() ? <MedTeamAssignTarget /> : <Navigate to="/medloginteam" />} />
        <Route path="/medteam/verticals" element={isAuthenticatedMedTeam() ? <MedTeamVerticals /> : <Navigate to="/medloginteam" />} />
        <Route path="/medteam/leaderboard" element={isAuthenticatedMedTeam() ? <MedLeaderboard /> : <Navigate to="/medloginteam" />} />
        {/* Med Team Panel End */}
