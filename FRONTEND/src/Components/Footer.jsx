      ...
      <div className="max-w-7xl mx-auto align-top">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-20 relative z-10">
          <a href="mailto:support@krutanic.com" className="bg-white hover:bg-orange-50/30 border border-gray-100/80 hover:border-orange-100 rounded-[28px] p-6 transition-all duration-300 group flex flex-col items-center text-center shadow-[0_8px_30px_rgba(0,0,0,0.03)] hover:shadow-[0_8px_30px_rgba(241,91,41,0.06)] hover:-translate-y-1">
            ...
            <h3 className="text-gray-900 font-bold tracking-wide mb-1">Email Us</h3>
          ...
          <a href="https://wa.me/7829104024" target="_blank" rel="noreferrer" className="bg-white hover:bg-green-50/30 border border-gray-100/80 hover:border-green-100 rounded-[28px] p-6 transition-all duration-300 group flex flex-col items-center text-center shadow-[0_8px_30px_rgba(0,0,0,0.03)] hover:shadow-[0_8px_30px_rgba(34,197,94,0.06)] hover:-translate-y-1">
            ...
            <h3 className="text-gray-900 font-bold tracking-wide mb-1">WhatsApp</h3>
            <p className="text-sm text-gray-500 group-hover:text-gray-700 font-medium">Instant Support</p>
          </a>
          ...
          <a href="https://maps.google.com/?q=Bengaluru,Karnataka" target="_blank" rel="noreferrer" className="bg-white hover:bg-orange-50/30 border border-gray-100/80 hover:border-orange-100 rounded-[28px] p-6 transition-all duration-300 group flex flex-col items-center text-center shadow-[0_8px_30px_rgba(0,0,0,0.03)] hover:shadow-[0_8px_30px_rgba(241,91,41,0.06)] hover:-translate-y-1">
            ...
            <h3 className="text-gray-900 font-bold tracking-wide mb-1">Location</h3>
            <p className="text-sm text-gray-500 group-hover:text-gray-700 font-medium">Bengaluru, Karnataka</p>
          </a>
        </div>

        {/* Main Footer Content */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-6 border-b border-gray-200/60 pb-12 relative z-10 w-full">
          ...
          {/* Links Col 1 - Offset for better spacing in 12-col grid */}
          ...
          {/* Payment Providers block wrapper - aligns end */}
