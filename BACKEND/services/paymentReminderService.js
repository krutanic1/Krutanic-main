    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="amount-highlight">
                ...
                <h2>₹${((student.programPrice || 0) - (student.paidAmount || 0)).toLocaleString('en-IN')
    }</h2>
            </div>
            ...
            <p style="text-align: center;">
                ...
                <a href="https://wa.me/917795680178?text=Hi%2C%20I%20need%20help%20with%20payment%20for%20${encodeURIComponent(student.fullname)}" target="_blank" class="cta-button" style="background: linear-gradient(135deg, #f15b29 0%, #ff8c5a 100%);">
                    Contact Support
                </a>
            </p>
            ...
            <div class="contact-info">
                ...
                2️⃣ After successful payment, share transaction details via WhatsApp/SMS to <strong>+91 7795680178</strong><br>
                ...
                Phone/WhatsApp: +91 7795680178<br>
                Website: www.krutanic.com
            </div>
            
            <p style="margin-top: 25px;">If you have already made the payment, please share the transaction details with us at <strong>+91 7795680178</strong>, and kindly ignore this reminder.</p>
