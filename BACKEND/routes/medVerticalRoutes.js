...
const { createVertical, getVerticals, getVerticalsByManager, updateVertical, deleteVertical, getVerticalEnrollments } = require("../controllers/medVerticalController");
