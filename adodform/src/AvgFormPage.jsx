        ...
        <div className="avg-container">
          ...
          <div className="avg-pain-grid">
            <div className="avg-pain-card">
               <img src={CardRoadmap} alt="Career Roadmap" className="pain-card-img" />
               <h4>Not sure which path to choose?</h4>
               <p>Confused between AI, Full Stack, or Cloud? We help you map your background to the right domain.</p>
               <div className="pain-solution"><strong>Step 1:</strong> Career roadmap based on your goals</div>
            </div>
            <div className="avg-pain-card">
               <img src={CardPortfolio} alt="Portfolio" className="pain-card-img" />
               <h4>No recruiter-ready portfolio?</h4>
               <p>Tutorials aren't enough. You need deployable projects that prove you can write production code.</p>
               <div className="pain-solution"><strong>Step 2:</strong> Build proof of skill with guided projects</div>
            </div>
            <div className="avg-pain-card">
               <img src={CardSuccess} alt="Success" className="pain-card-img" />
               <h4>Struggling to get shortlists?</h4>
               <p>Preparing for internships and placements requires resume strategy and interview practice.</p>
               <div className="pain-solution"><strong>Step 3:</strong> Prepare to convert with placement readiness</div>
            </div>
          </div>
        </div>
      </section>
