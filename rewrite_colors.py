...
new_jsx = """  return (
    <div id="MasterClass" className="max-w-[100vw] overflow-x-hidden bg-black font-sans text-gray-200">
      ...
      <section className="relative w-full pt-28 pb-20 px-4 md:px-8 lg:px-16 flex flex-col items-center text-center overflow-hidden">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/20 backdrop-blur-md mb-8 shadow-[0_0_15px_rgba(0,255,204,0.15)]">
            <span className="relative flex h-3 w-3">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#00ffcc] opacity-75"></span>
              <span className="relative inline-flex rounded-full h-3 w-3 bg-[#00ffcc]"></span>
            </span>
            <span className="text-sm font-bold text-white uppercase tracking-widest">The Clock Is Ticking</span>
          </div>
          ...
          <div className="mt-8 flex items-center gap-4 text-sm text-gray-400 font-bold tracking-wide">
            <div className="flex -space-x-3">
              <img className="w-10 h-10 rounded-full border-2 border-black" src="https://i.pravatar.cc/100?img=1" alt="User" />
              <img className="w-10 h-10 rounded-full border-2 border-black" src="https://i.pravatar.cc/100?img=2" alt="User" />
              <img className="w-10 h-10 rounded-full border-2 border-black" src="https://i.pravatar.cc/100?img=3" alt="User" />
              <div className="w-10 h-10 rounded-full border-2 border-black bg-gray-800 flex items-center justify-center text-xs text-white">+5k</div>
            </div>
      ...
      {/* What You Will Learn */}
      <section className="relative w-full py-20 px-4 md:px-8 lg:px-16 bg-[#050505] border-y border-white/10">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">Here&apos;s what you can expect to learn</h2>
            <p className="text-xl text-gray-400 font-medium">Practical, outcome-driven frameworks designed for career acceleration.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <motion.div 
                ...
                key={i} 
                className="group relative p-6 md:p-8 rounded-2xl bg-[#0a0a0a] border border-[#00ffcc]/30 hover:border-[#00ffcc] transition-all duration-300 overflow-hidden shadow-[0_0_15px_rgba(0,255,204,0.05)] hover:shadow-[0_0_30px_rgba(0,255,204,0.2)]"
              >
                <div className="relative z-10 flex items-start gap-5">
                  <div className="text-4xl text-[#00ffcc] mt-1 drop-shadow-[0_0_8px_rgba(0,255,204,0.5)]">
                    {item.icon}
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-white mb-3 tracking-wide">{item.title}</h3>
                    <p className="text-gray-300 leading-relaxed font-medium text-[15px]">{item.desc}</p>
                  </div>
                </div>
              </motion.div>
            ))}
      ...
      {/* Who is this for? */}
      <section className="relative w-full py-24 px-4 md:px-8 lg:px-16 bg-black">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">Who is this for?</h2>
            <p className="text-xl text-gray-400 max-w-2xl mx-auto font-medium">If you want to stay relevant, increase your value, and lead in your industry, you need to be here.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div 
                ...
                transition={{ delay: i * 0.1 }}
                key={i} 
                className="relative rounded-2xl overflow-hidden aspect-[4/5] border border-white/20 group hover:border-[#00ffcc] transition-colors duration-500"
              >
                ...
                <div className={`absolute inset-0 bg-gradient-to-t ${role.color} via-black/60 to-black/20 opacity-90`}></div>
                <div className="absolute inset-0 p-6 flex flex-col justify-end">
                  <h3 className="text-2xl font-extrabold text-white tracking-wide">{role.title}</h3>
                </div>
              </motion.div>
            ))}
          </div>
          
          <div className="mt-16 text-center max-w-4xl mx-auto p-8 rounded-2xl bg-[#0a0a0a] border border-[#00ffcc]/20 shadow-[0_0_30px_rgba(0,255,204,0.1)]">
            <p className="text-lg md:text-xl text-gray-300 leading-relaxed font-semibold">
              <strong className="text-[#00ffcc] font-extrabold text-2xl drop-shadow-[0_0_8px_rgba(0,255,204,0.4)]">Picture this: </strong> 
              In just a few months, you&apos;ve mastered the exact skills top employers are demanding right now. Your professional value has skyrocketed, you&apos;re building production-grade projects effortlessly, and you&apos;re at the forefront of the technological wave instead of struggling to catch up.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* Testimonials */}
      <section className="relative w-full py-24 px-4 md:px-8 lg:px-16 bg-[#050505]">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl h-full bg-[#00ffcc]/5 blur-[120px] pointer-events-none"></div>
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">Don&apos;t Just Take Our Word For It</h2>
            <p className="text-xl text-gray-400 font-medium">Industry leaders are already confirming what we know.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            {[
              ...
              <motion.div 
                ...
                transition={{ delay: i * 0.1 }}
                key={i} 
                className="p-8 rounded-2xl bg-white border border-gray-200 shadow-[0_0_40px_rgba(0,255,204,0.3)] transition-all duration-300 hover:scale-[1.02]"
              >
                <div className="flex justify-between items-start mb-6">
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 rounded-full bg-black flex items-center justify-center text-white font-extrabold text-2xl">
                      {tweet.name.charAt(0)}
                    </div>
                    <div>
                      <h4 className="font-extrabold text-black text-lg">{tweet.name} <span className="text-blue-500 ml-1">✓</span></h4>
                      <p className="text-gray-500 font-medium">{tweet.handle}</p>
                    </div>
                  </div>
                  <FaTwitter className="text-3xl text-blue-500" />
                </div>
                <p className="text-xl text-black font-medium mb-6 leading-relaxed">{tweet.text}</p>
                <div className="text-sm text-gray-500 font-medium border-t border-gray-200 pt-4 flex flex-col sm:flex-row sm:justify-between gap-2">
                  <span>{tweet.date}</span>
                  <span><strong className="text-black">{tweet.stats.split(' · ')[0]}</strong> · <strong className="text-black">{tweet.stats.split(' · ')[1]}</strong></span>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      {/* Certificate Section */}
      <section className="relative w-full py-24 px-4 md:px-8 lg:px-16 bg-black overflow-hidden border-t border-white/10">
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#00ffcc]/10 blur-[150px] rounded-full pointer-events-none"></div>
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 lg:pr-10 relative z-10">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#00ffcc]/10 border border-[#00ffcc]/30 text-[#00ffcc] font-bold mb-6">
            ...
            <ul className="space-y-5 mb-10">
              {['Verifiable Credentials', 'Shareable on LinkedIn', 'Lifetime Validity'].map((item, i) => (
                <li key={i} className="flex items-center gap-4 text-white font-bold text-lg">
                  <FaCheckCircle className="text-[#00ffcc] text-2xl drop-shadow-[0_0_8px_rgba(0,255,204,0.6)]" /> {item}
                </li>
              ))}
            </ul>
          </div>
          ...
          >
            <div className="absolute -inset-2 bg-gradient-to-r from-[#00ffcc] to-purple-600 rounded-2xl blur opacity-30 group-hover:opacity-60 transition duration-1000"></div>
            <img src={img} alt="Certificate preview" className="relative w-full rounded-2xl border-2 border-white/20 shadow-2xl" />
          </motion.div>
        </div>
      </section>

      {/* ACTIVE CLASSES LISTING */}
      <section className="relative w-full py-24 px-4 md:px-8 lg:px-16 bg-[#050505] border-t border-white/10" id="active-classes">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#00ffcc]/10 border border-[#00ffcc]/30 text-[#00ffcc] font-bold mb-6 shadow-[0_0_15px_rgba(0,255,204,0.2)]">
            ...
            <h2 className="text-3xl md:text-5xl font-extrabold text-white mb-4">Secure Your Spot</h2>
            <p className="text-xl text-gray-400 font-medium">Join our hands-on, expert-led masterclasses before they fill up.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {activeMasterClasses.map((masterclass) => {
              return (
                <motion.article 
                  whileHover={{ y: -5 }}
                  className="flex flex-col bg-[#0a0a0a] rounded-2xl border border-white/10 overflow-hidden shadow-2xl w-full max-w-[420px] mx-auto cursor-pointer group hover:border-[#00ffcc]/50 transition-all duration-300"
                  key={masterclass._id}
                  onClick={(e) => {
                ...
                >
                  <div className="relative overflow-hidden h-[200px]">
                    <img
                      ...
                      className="w-full h-[200px] object-cover transition-transform duration-700 group-hover:scale-110 opacity-90 group-hover:opacity-100"
                    ...
                    <span className={`absolute top-3 left-3 px-4 py-1.5 rounded-full text-[11px] font-extrabold uppercase tracking-wider shadow-lg border ${
                      masterclass.status === "upcoming"
                        ? "bg-purple-600/90 border-purple-400/50 text-white backdrop-blur-sm"
                        : masterclass.status === "ongoing"
                        ? "bg-[#00ffcc]/90 border-[#00ffcc]/50 text-black backdrop-blur-sm"
                        : "bg-gray-700/90 border-gray-500/50 text-white backdrop-blur-sm"
                    }`}>
                      {masterclass.status}
                    </span>
                  </div>

                  <div className="p-6 flex flex-col gap-5 flex-grow justify-between relative z-10 -mt-6 bg-[#0a0a0a] rounded-t-3xl">
                    <div className="flex flex-col gap-3">
                      <div className="flex items-center gap-2 w-max px-3 py-1.5 bg-white/5 border border-white/10 rounded-lg text-white text-[11px] font-extrabold tracking-wider uppercase backdrop-blur-md">
                        <i className="fa fa-fire text-orange-500 text-sm drop-shadow-[0_0_5px_rgba(249,115,22,0.8)]"></i>
                        <span>
                      ...
                      <h3 className="text-xl font-extrabold text-white leading-snug group-hover:text-[#00ffcc] transition-colors line-clamp-2 min-h-[56px]">
                        {masterclass.title}
                      </h3>
                    </div>
                    ...
                    <div className="flex flex-col gap-5">
                      <div className="border-t border-white/10 pt-5 flex flex-col gap-1.5">
                        <span className="text-[11px] text-gray-500 uppercase tracking-widest font-extrabold flex items-center gap-1.5"><FaRegClock className="text-[#00ffcc]" /> Starts On</span>
                      ...
                      <div className="flex items-center gap-3">
                        <button
                          className="flex-grow py-4 bg-white/5 hover:bg-[#00ffcc] text-white hover:text-black text-[13px] font-extrabold uppercase rounded-xl text-center transition-all duration-300 tracking-wider flex items-center justify-center gap-2 border border-white/20 hover:border-[#00ffcc] hover:shadow-[0_0_20px_rgba(0,255,204,0.5)]"
                          onClick={() =>
                        ...
                        <button
                          className="p-4 border border-white/20 hover:border-[#00ffcc] hover:bg-[#00ffcc]/10 hover:text-[#00ffcc] text-gray-400 rounded-xl transition-all duration-300"
      ...
      {completedMasterClass.length > 0 && (
          <section className="relative w-full py-24 px-4 md:px-8 lg:px-16 bg-black border-t border-white/10">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl md:text-5xl font-extrabold text-white mb-4">Past Masterclasses</h2>
                <p className="text-xl text-gray-400 font-medium">Missed a session? You can still catch up.</p>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {[...completedMasterClass]
                  ...
                  .slice(0, 8)
                  .map((masterclass) => (
                    <div className="bg-[#0a0a0a] border border-white/10 rounded-xl overflow-hidden group hover:border-[#00ffcc]/50 transition-colors shadow-lg" key={masterclass._id}>
                      <img
                        src={convertGoogleDriveUrl(masterclass.image)}
                        alt={masterclass.title}
                        className="w-full h-36 object-cover opacity-70 group-hover:opacity-100 transition-opacity"
                        onError={(e) => (e.target.src = imgalt)}
                      />
                      <div className="p-5">
                        <h3 className="text-[15px] font-bold text-white line-clamp-2 mb-2 group-hover:text-[#00ffcc] transition-colors">{masterclass.title}</h3>
                        <p className="text-xs text-gray-500 font-medium mb-4">{formatClassDate(masterclass.end)}</p>
                        {masterclass.pdfstatus && (
                          <button 
                            onClick={() => handleDownload(masterclass)}
                            className="text-[13px] font-bold text-[#00ffcc] hover:text-white transition-colors flex items-center gap-1.5"
                          >
      ...
      {/* FAQs */}
      <section className="relative w-full py-24 px-4 md:px-8 lg:px-16 bg-[#050505] border-t border-white/10">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <div key={index} className="border border-white/10 rounded-xl bg-[#0a0a0a] overflow-hidden transition-colors hover:border-[#00ffcc]/30">
                <button 
                  onClick={() => toggleFAQ(index)}
                  className="w-full px-6 py-5 flex items-center justify-between text-left focus:outline-none"
                >
                  <span className="font-extrabold text-white text-lg">{faq.question}</span>
                  <span className={`text-[#00ffcc] text-xl transform transition-transform ${openIndex === index ? 'rotate-45' : ''}`}>
                    <i className="fa fa-plus"></i>
                  </span>
                </button>
                {openIndex === index && (
                  <div className="px-6 pb-5 pt-2 text-gray-400 font-medium border-t border-white/5 text-[15px] leading-relaxed">
                    {faq.answer}
                  </div>
                )}
              </div>
      ...
      {/* Final CTA */}
      <section className="relative w-full py-28 px-4 md:px-8 lg:px-16 text-center overflow-hidden bg-black border-t border-white/10">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[800px] h-[400px] bg-[#00ffcc]/10 blur-[150px] rounded-full pointer-events-none z-0"></div>
      ...
      {isRegisterForm && selectedMasterClass && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-md p-4">
          <motion.div 
            ...
            className="bg-[#0a0a0a] border border-[#00ffcc]/30 rounded-2xl w-full max-w-md overflow-hidden shadow-[0_0_50px_rgba(0,255,204,0.2)]"
          >
            <div className="p-6 flex justify-between items-center bg-black border-b border-white/10">
              <h3 className="font-extrabold text-white text-xl">Register NOW!</h3>
              <button onClick={closeForm} className="text-gray-400 hover:text-white transition-colors">
                <i className="fa fa-close text-2xl"></i>
              </button>
            </div>
            <div className="p-6">
              <h3 className="text-lg font-bold text-[#00ffcc] mb-6 leading-snug">{selectedMasterClass.title}</h3>
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                <input
                  ...
                  required
                  className="w-full bg-white/5 border border-white/10 rounded-xl px-5 py-4 text-white font-medium placeholder-gray-500 focus:outline-none focus:border-[#00ffcc] focus:ring-1 focus:ring-[#00ffcc] transition-all"
                />
                <input
                  type="email"
                ...
                <select
                  ...
                  onChange={handleChange}
                  required
                  className="w-full bg-[#111] border border-white/10 rounded-xl px-5 py-4 text-white font-medium focus:outline-none focus:border-[#00ffcc] transition-all appearance-none"
                >
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl px-5 py-4 text-white font-medium placeholder-gray-500 focus:outline-none focus:border-[#00ffcc] focus:ring-1 focus:ring-[#00ffcc] transition-all"
                />
                <button type="submit" className="w-full py-4 mt-4 bg-[#00ffcc] hover:bg-[#00e6b8] text-black text-lg font-extrabold rounded-xl shadow-[0_0_20px_rgba(0,255,204,0.3)] transition-all">
                  SUBMIT REGISTRATION
                </button>
                <p className="text-sm text-gray-400 text-center mt-3 font-medium">
                  <span className="text-[#00ffcc] font-extrabold">NOTE:</span> Enter details carefully, they will appear on your certificate.
                </p>
              </form>
            </div>
          </motion.div>
      ...
      {isDownloadForm && selectedMasterClass && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-md p-4">
          ...
          >
            <div className="p-6 flex justify-between items-center bg-black border-b border-white/10">
              <h3 className="font-extrabold text-white text-xl">Download Certificate</h3>
              <button onClick={closeForm} className="text-gray-400 hover:text-white transition-colors">
                <i className="fa fa-close text-2xl"></i>
              </button>
            </div>
            <div className="p-6">
              ...
              <form onSubmit={downloadCertificate} className="flex flex-col gap-4">
                ...
                <p className="text-sm text-gray-400 text-center mt-3 font-medium">
                  <span className="text-[#00ffcc] font-extrabold">NOTE:</span> Please enter the same Email that you used during registration.
                </p>
              </form>
            </div>
          </motion.div>
